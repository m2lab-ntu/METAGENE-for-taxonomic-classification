...
OUTPUT_DIR="outputs/diagnosis_50_generanno"
CONFIG="metaclassifier/configs/generanno_transformer.yaml"

# 1. Prepare Data (Skipping as it's already done)
...
# 2. Run Training
echo "Step 2: Starting training with GENERanno..."
